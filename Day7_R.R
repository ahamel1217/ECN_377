...
probs <- c(0.4, 0.1, 0.1, 0.4)  # they tend to AGREE -> expect a positive relationship
...
sdX <- sqrt(0.25)                # sqrt(EX - EX^2)
sdY <- sqrt(0.25)                # sqrt(EY - EY^2)
...
edu12 <- wage1$educ[wage1$educ == 12]         # E[educ | educ = 12] = mean of educ AMONG the educ==12 people (guess first!)
mean(edu12)  #yay

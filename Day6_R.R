...
EX <- 2
EY <- 3   # E[4X + 5Y - 3]    -- use linearity; E[constant] = the constant
4 * EX + 5 * EY - 3
...
xj <- _____       # x across pairs (0,0) (0,1) (1,0) (1,1)
yj <- _____        # y across those same pairs
pj <- _____      # probability of each pair
EXY <- _____     # E[XY]                 -- same idea, weight xj*yj
